...
# Dump component data
# This script is not intended for a data migration to another Referentielijsten instance.
...
export PGUSER=${DB_USER:-referentielijsten}
export PGDATABASE=${DB_NAME:-referentielijsten}
