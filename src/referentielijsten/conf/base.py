...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "referentielijsten"),
        "USER": config("DB_USER", "referentielijsten"),
        "PASSWORD": config("DB_PASSWORD", "referentielijsten"),
...
ROOT_URLCONF = "referentielijsten.urls"
...
DEFAULT_FROM_EMAIL = "referentielijsten@example.com"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"referentielijsten {ENVIRONMENT}",
